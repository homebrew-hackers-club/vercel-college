...
![Two side-by-side diagrams, left showing the HTML code, and right showing the DOMtree.](/assets/learn-html-and-dom.webp)
...
You can use DOM methods and JavaScript, to listen to user events and [manipulate the DOM](https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Scripting/DOM_scripting)

...
![Example of a Media Component made up of 3 smaller components: image, text, and button](/assets/learn-components.png)
...
![Component tree showing how components can be nested inside each other](/assets/learn-component-tree.png)

---
title: cacheComponents — Deep Dive Developer Guide
...
It's a major philosophical shift — giving developers full control over when and how caching happens.
...
With `cacheComponents: true`, these APIs are no longer optional — they become core primitives for controlling data persistence.
...
2. **Identify where stale data matters** — those are safe to leave dynamic.

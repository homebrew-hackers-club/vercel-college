...
description: Learn how to integrate AI coding agents with your Next.js development workflow using Model Context Protocol (MCP) servers
banner: assets/mcp-banner.png
---
...
prompt='What are the key steps to set up MCP servers in your Next.js development environment? What would you do if the servers arent connecting?'
/>
